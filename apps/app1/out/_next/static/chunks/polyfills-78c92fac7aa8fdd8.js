!(function () {
	...
	var Jt =
			...
			function (t, e) {
				var r
				return (
					null !== t ? ((Ht[Gt] = j(t)), (r = new Ht()), (Ht[Gt] = null), (r[Vt] = t)) : (r = Yt()),
					void 0 === e ? r : Wt(r, e)
				)
			},
		Qt = qt("unscopables"),
	...
	var Oe,
		...
		_e = !1
	;[].keys &&
		("next" in (je = [].keys()) ? (Re = Ue(Ue(je))) !== Object.prototype && (Oe = Re) : (_e = !0)),
		null == Oe && (Oe = {}),
		w(Oe, Me) ||
			T(Oe, Me, function () {
				return this
		...
		Ze = function (t, e, r, n, o, i, a) {
			...
			if (
				(g &&
					...
					$e !== Object.prototype &&
						u.next &&
						(Ue(u) !== $e && (Ge ? Ge(u, $e) : "function" != typeof u[He] && T(u, He, Qe)),
						Be(u, l, !0))),
				o == Ye &&
					d &&
					d.name !== Ye &&
	...
	var Nr = !o(function () {
		...
		qr = function (t, e, r) {
			...
			return (
				(l[t] = f), Lt({ global: !0, forced: f != s }, l), Be(f, t), a || r.setStrong(f, t, i), f
			)
		},
		zr = function (t, e, r) {
		...
		Xr = {
			getConstructor: function (t, e, r, n) {
				var o = t(function (t, a) {
						Br(t, o, e),
							Vr(t, { type: e, index: Jt(null), first: void 0, last: void 0, size: 0 }),
							i || (t.size = 0),
							null != a && Fr(a, t[n], t, r)
					}),
					a = Hr(e),
				...
				return (
					zr(o.prototype, {
						...
						forEach: function (t) {
							for (
								var e, r = a(this), n = re(t, arguments.length > 1 ? arguments[1] : void 0, 3);
								(e = e ? e.next : r.first);
				...
				[
					...
					function (t, o) {
						...
						for (var h = 0, p = 0, d = []; p < u.length; ) {
							...
							if (null === g || (v = Yi(ft(f.lastIndex + (Qi ? 0 : p)), u.length)) === h)
								p = zi(u, p, c)
							else {
	...
	var va = wt.f,
		...
		$a = function (t, e, r) {
			...
			return (
				...
				w(Na, n)
					? (r.enumerable
							? (w(t, xa) && t[xa][n] && (t[xa][n] = !1), (r = Jt(r, { enumerable: f(0, !1) })))
	...
	var bu =
		...
		Su = function (t) {
			return function (e, r, n) {
				...
				return c <= u || "" == s
					? a
					: ((i = bu.call(s, wu((o = c - u) / s.length))).length > o && (i = i.slice(0, o)),
						t ? a + i : i + a)
			}
		},
	...
	var Fu = qt("iterator"),
		...
		vs = function (t, e) {
			if (e)
				for (var r, n, o = e.split("&"), i = 0; i < o.length; )
					(r = o[i++]).length &&
						((n = r.split("=")), t.push({ key: fs(n.shift()), value: fs(n.join("=")) }))
		},
		gs = function (t) {
		...
		bs = function () {
			...
			var t,
				...
				f = []
			if (
				(ns(this, { type: es, entries: f, updateURL: function () {}, updateSearchParams: gs }),
				void 0 !== c)
			)
				if (y(c))
					...
					fetch: function (t) {
						...
						return (
							arguments.length > 1 &&
								(y((e = arguments[1])) &&
									pr((r = e.body)) === es &&
									((n = e.headers ? new Zu(e.headers) : new Zu()).has("content-type") ||
			...
			for (
				...
				switch (((i = o[f]), c)) {
					...
					case Sc:
						if (((t.scheme = "file"), "/" == i || "\\" == i)) c = Ec
							...
							if (i == Ss) (t.host = n.host), (t.path = n.path.slice()), (t.query = n.query)
								...
								(t.host = n.host), (t.path = n.path.slice()), (t.query = ""), (c = jc)
							else {
								if ("#" != i) {
									ic(o.slice(f).join("")) || ((t.host = n.host), (t.path = n.path.slice()), ac(t)),
										(c = Oc)
									continue
								}
								;(t.host = n.host),
					...
					case jc:
						r || "#" != i
							? i != Ss &&
								("'" == i && ec(t) ? (t.query += "%27") : (t.query += "#" == i ? "%23" : Zs(i, Xs)))
							: ((t.fragment = ""), (c = Pc))
						break
					case Pc:
	...
	function Ul(t, e) {
		...
		if (
			...
			(this.method =
				((n = (r = e.method || this.method || "GET").toUpperCase()), Ll.indexOf(n) > -1 ? n : r)),
